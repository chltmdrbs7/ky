...
function showLoginModal() {
  ...
  modal.innerHTML = `
    <style>
      ...
      .login-box {
        background: linear-gradient(145deg, #1E3A5F, #2B4A6F);
...
// 전역 함수 등록
window.kyAuth = { checkAuth, login, logout, showLoginModal };
